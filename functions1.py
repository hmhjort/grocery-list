...
def get_recipe(query):
    url = "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/complexSearch?number=5"

    query_string = {"query": query}
    headers = {
	            "X-RapidAPI-Key": "ae544d1e6emsh706d5c690f30286p19e544jsn7eb344e8d3c5",
...
ingred_list = {"ingredients": ["2.0 tablespoons finely chopped parsley", "3 teaspoons extra-virgin olive oil, or more to taste", "1 1/2 tbsp cinnamon"]}
ingred_list_2 = {"ingredients": ["2 1/2 tablespoons finely chopped parsley", "20 tablespoons extra-virgin olive oil, or more to taste", "1 1/2 tbsp cinnamon"]}
ingred_list_3 = {"ingredients": ["1 cup all-purpose flour", "1/3 cup cocoa", "3/4 tsp baking powder", "1 cup white sugar"]}

total_ingred = [ingred_list, ingred_list_2]
